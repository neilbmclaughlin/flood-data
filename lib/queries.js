module.exports = {
  ...
  refreshStationMviews: 'REFRESH MATERIALIZED VIEW u_flood.telemetry_context_mview with data; REFRESH MATERIALIZED VIEW u_flood.station_split_mview with data; REFRESH MATERIALIZED VIEW u_flood.stations_overview_mview WITH DATA; REFRESH MATERIALIZED VIEW u_flood.impact_mview WITH DATA; REFRESH MATERIALIZED VIEW u_flood.rivers_mview WITH DATA; REFRESH MATERIALIZED VIEW u_flood.rainfall_stations_mview WITH DATA; REFRESH MATERIALIZED VIEW u_flood.stations_list_mview WITH DATA;',
